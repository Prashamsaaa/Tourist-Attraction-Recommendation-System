...
\begin{longtable}{|p{0.5cm}|p{4cm}|p{4cm}|p{0.8cm}|p{5cm}|}
\caption{Review Matrix with Research Papers, Authors and Performance.\label{Research Papers with their authors}} \\
\hline
\textbf{SN} & \textbf{Title} & \textbf{Author} & \textbf{Year} & \textbf{Description} \\
\hline
\endfirsthead
...
\hline
9 & New Smart Map for Tourism Using Artificial Intelligence & Wahyono, Irawan Dwi; Asfani, Khoirudin; Mohamad, Mohd Murtadha; Aripriharta, A; Wibawa, Aji P; Wibisono, Waskitho & 2020 & Introduces a smart map that utilizes AI to enhance tourism experiences. \\
\hline
10 & Recommendation System Based on Tourist Attraction & Manjare, PA; Vninawe, MP; Dabhire, MM; Bonde, MR; Charhate, MD & 2016 & Proposes a recommendation system for suggesting tourist attractions. \\
\hline
